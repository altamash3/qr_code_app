class QrcodesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @qrcode.save
        format.html { redirect_to qrcode_url(@qrcode), notice: "Qrcode was successfully created." }
  ...
  private
    ...
    def set_qrcode
      @qrcode = Qrcode.last#find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def qrcode_params
      params.require(:qrcode).permit(:name, :facts)
    end
end
